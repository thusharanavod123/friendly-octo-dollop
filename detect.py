            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        #label ekk print wenna terminal eke
                        print("Label*******", label)
  #counting                      
    ...
    #api hadagtta function ek call krnw label ek daagnna                    
             
                showCountLabel(im0,"cow count "+ str(cowCount),(20,40),(255,0,0))    
            #me ytadi aaye 0 kle nthnm frame wens weddi count wadi wn nisa
...
#create function to display count
